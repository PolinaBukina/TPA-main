...
import CourseClass from "./screen/course/CourseClass.jsx"
...
import CreateClass from "./screen/dashboard/course/CreateClass.jsx";
import CreateCourseHome from "./screen/dashboard/course/CreateCourseHome.jsx";
...
import Success from "./screen/course/Success";
import CreateReview from "./screen/reviews/CreateReview.jsx";
import DisplayReviews from "./screen/reviews/DisplayReviews.jsx";
    ...
    <Router>
      <Routes>
        <Route path="/" element={<Boilerplate />}>
          ...
          <Route path="create-reviews" element={<CreateReview />} />
          <Route path="reviews" element={<DisplayReviews />} />

          <Route path="course" element={<Course />}>
            <Route index element={<CourseHome />} />
            <Route path="course-detail/course-class/:id" element={<CourseClass />} />
            <Route path="course-detail" element={<CourseDetail />} />
            <Route path="course-detail/course-class/:id/success" element={<Success />} />
          </Route>
          ...
          <Route path="dashboard" element={<Dashboard />}>
            ...
            <Route path="create-course" element={<CreateCourse />}>
              <Route index element={<CreateCourseHome />} />
              <Route path="add-class/:id" element={<CreateClass />} />
            </Route>
